...
function OfferPage({ offers }: OfferProps) {
    ...
    const handleReviewSubmit = (newReview: {
        ...
        // Создаем новый отзыв в том же формате, что и моковые данные
        const addedReview = {
            id: `new-${Date.now()}`, // Генерируем уникальный ID
            date: new Date().toISOString(),
            user: {
                name: 'Current User', // Имя текущего пользователя
                avatarUrl: '/img/avatar-default.jpg', // Аватар по умолчанию
                isPro: false,
            },
        ...
        setCurrentReviews([addedReview, ...currentReviews]); // Добавляем новый отзыв в начало списка
    };
